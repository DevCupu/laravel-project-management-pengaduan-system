...
@section('content')
    <div class="container mx-auto py-12 flex justify-center px-4">
        <div class="w-full max-w-lg bg-white shadow-2xl shadow-slate-200 rounded-3xl p-10 border border-slate-100">
            <h1 class="text-3xl font-black text-gray-900 mb-2 text-center">Tambah Bidang Baru</h1>
            <p class="text-center text-slate-500 mb-8 text-sm">Definisikan kategori layanan baru untuk memudahkan warga Malimongan menyampaikan aspirasinya.</p>
